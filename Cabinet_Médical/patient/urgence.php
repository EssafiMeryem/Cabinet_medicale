...
<body>
  ...
  <div class="row">
  <div class="col-md-6">
  <h5 class="text-center my-4">Urgence</h5>
  <?php
  $query="SELECT * FROM consultation WHERE title ='urgence'";
  ...
  while($row=mysqli_fetch_array($res)){
    ...
    <td>
    <a href='urgence.php?ID=$ID'><button ID='$ID' class='btn btn-danger remove'>Supprimer</button></a>
    </td>
    ";
